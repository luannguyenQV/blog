...
exports.default = (0, _withViews2.default)(function (_ref) {
  ...
  return _react2.default.createElement(_post2.default, null, _react2.default.createElement(_head2.default, null, _react2.default.createElement('title', null, 'I am Jhonny')), _react2.default.createElement(_title2.default, null, 'I am Jhonny'), _react2.default.createElement(_meta2.default, { date: 'February 4, 2016', views: views }), _react2.default.createElement(_paragraph2.default, null, 'This is meant to be my ', _react2.default.createElement('b', null, 'personal'), ' blog.'));
});